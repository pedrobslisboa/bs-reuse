...
var ReUse_Button$BsReuse = require("../src/ReUse_Button/ReUse_Button.bs.js");
...
React$1.storiesOf("Elements | ReUse_Button", _module).add("default", (function (param) {
              return React.createElement(ReUse_Button$BsReuse.make, {
                          children: "DEFAULT"
                        });
          ...
          return React.createElement("div", undefined, React.createElement(ReUse_Button$BsReuse.make, {
                          children: "TEXT",
